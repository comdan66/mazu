...
task('deploy', function () {
  ...
  echo cliColor("   ➜ ", 'R') . "檢查路徑 " . cliColor(get('deployPath'), 'W') . " 是否正確" . cliColor(' ─ ', 'N');
  ...
  echo cliColor("   ➤ ", 'R') . "進入專案目錄：" . cliColor(get('deployPath'), 'W') . cliColor(' ─ ', 'N');
  cd('{{deployPath}}');
  echo cliColor(" ✔ 成功", 'g') . "\n";
  ...
  // writeln(" <info>✔</info> git " . $cmd . " 執行成功！");
})->shallow();
